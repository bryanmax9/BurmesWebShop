...
export function AuthProvider({ children }) {
  ...
  const createProduct = async (productData) => {
    ...
    const ref = await addDoc(collection(db, PRODUCTS_COLLECTION), {
      ...
      videoFileIds: Array.isArray(productData.videoFileIds) ? productData.videoFileIds : [],
      ...
      driveFileIds: Array.isArray(productData.driveFileIds) ? productData.driveFileIds : [],
      sku: productData.sku || null,
      material: productData.material || null,
      gender: productData.gender || null,
      isNovios: productData.isNovios === true,
      noviosCategory: productData.noviosCategory || null,
      gemType: productData.gemType || null,
      isZodiac: productData.isZodiac === true,
      zodiacSign: productData.zodiacSign || null,
      isLetterCollection: productData.isLetterCollection === true,
      letterValue: productData.letterValue || null,
